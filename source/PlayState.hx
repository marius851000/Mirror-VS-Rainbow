...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'the-pony-hamsterdance':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/the-pony-hamsterdance/the-pony-hamsterdanceDialogue'));
			case 'roses':
				...
				case 'rdStage':
					{
						...
						var bg:FlxSprite = new FlxSprite(-200,-50).loadGraphic(Paths.image('rd/bg'));
						bg.antialiasing = true;
	...
	override function beatHit()
	{
		...
		if (curSong == 'The Pony Hamsterdance')
			{
			if (curBeat > 167 && curBeat < 201)
				{
				if (curBeat % 4 == 1 && curBeat > 167)
					{
					dad.playAnim('singLEFT', true);
					}
				if (curBeat % 4 == 3 && curBeat > 167)
					{
					dad.playAnim('singRIGHT', true);
					boyfriend.playAnim('hey', true);
					}
				if (curBeat % 4 == 1 && curBeat > 183)
					{
					dad.playAnim('singUP', true);
					}
				if (curBeat % 4 == 3 && curBeat > 183)
					{
					dad.playAnim('singDOWN', true);
					boyfriend.playAnim('hey', true);
					}
				}
			else if (curBeat % 4 == 1 || curBeat % 4 == 2 || curBeat % 4 == 3 || curBeat % 4 == 4)
				{
