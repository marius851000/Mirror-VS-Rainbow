...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'rd':
				frames = Paths.getSparrowAtlas('rd/rd_asset');
				
				animation.addByPrefix('idle','rd idle', 24, false);
				animation.addByPrefix('singUP','rd up', 24, false);
				animation.addByPrefix('singDOWN','rd down', 24, false);
				animation.addByPrefix('singLEFT','rd left', 24, false);
				animation.addByPrefix('singRIGHT','rd right', 24, false);			
